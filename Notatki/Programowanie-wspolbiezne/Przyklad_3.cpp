 ...
 *    https://github.com/PacktPublishing/The-Modern-Cpp-Challenge/blob/master/Chapter07/problem_63/main.cpp
...
auto Max2(It begin, It end)
{
      ...
      for (int i = 0; i < task_count; ++i)
      {
		 ...
		 tasks.push_back(std::async(std::launch::async, [part_begin, part_end]() { return *std::max_element(part_begin, part_end); }));
      }
